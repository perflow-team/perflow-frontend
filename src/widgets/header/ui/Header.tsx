...
function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid h-16 max-w-[1168px] grid-cols-[minmax(0,1fr)_auto] items-center px-4 md:px-10 lg:grid-cols-[1fr_auto_1fr]">
        <Link to="/" className="min-w-0 justify-self-start">
          <img src={wordmark} alt="perflow" className="h-9 w-auto max-w-full object-contain md:h-12" />
        </Link>
